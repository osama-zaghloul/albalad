                        ...
                        <div class="modal-body">
                            {{ Form::open(array('method' => 'POST','files'=>true,'url' => 'adminpanel/wcategories')) }}
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input style="width:100%;" type="number" class="form-control" name="price" placeholder="سعر الوزن"  required>
                                        @if ($errors->has('price'))
                                            ...
                                            <div class="modal-body">
                                                {{ Form::open(array('method' => 'patch','files'=>true,'url' => 'adminpanel/wcategories/'.$weight->id )) }}
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label> سعر الوزن</label>
                                                        <div class="form-group col-md-12">
                                                            <input style="width:100%;" type="number" class="form-control" name="price" placeholder="سعر الوزن"" value="{{$weight->price}}"  required>
                                                        @if ($errors->has('price'))
                                                            <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('price') }}</div>
                                                        @endif
                                                        </div>  
